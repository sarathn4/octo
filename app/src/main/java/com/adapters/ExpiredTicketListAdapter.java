 ...
 */
public class ExpiredTicketListAdapter extends BaseAdapter{
    Context context;
    ArrayList<ExpiredTicket> expiredTickets;
    Mydatabase mydatabase;
    public ExpiredTicketListAdapter(Context context,ArrayList<ExpiredTicket> expiredTickets){
    ...
    public Object getItem(int position) {
        return expiredTickets.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ExpiredTicket expiredTicket = (ExpiredTicket) getItem(position);
        ...
        if(expiredTicket.getNo_of_tickets().equals("1")){
            textView_no_of_tickets.setText(expiredTicket.getNo_of_tickets() + " TICKET");
        } else {
            textView_no_of_tickets.setText(expiredTicket.getNo_of_tickets() + " TICKETS");
        }

        textView_ticket_no.setText(expiredTicket.getTicket_no());
        textView_station.setText(mydatabase.getStationName(expiredTicket.getFrom_station()));
        textView_date.setText(getDateAndTime(expiredTicket.getActivated_date()));
//        LayoutInflater layoutInflater = (LayoutInflater) context
//                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//        View view = layoutInflater.inflate(R.layout.verification_code_list_item, null);
//        TextView ticket_no,icon_source,icon_destination;
//
//        ticket_no = (TextView) view.findViewById(R.id.textView_code);
...
//
//        ExpiredTicket expiredTicket = (ExpiredTicket) getItem(position);
//        ticket_no.setText(expiredTicket.getTicket_no());
//        icon_source.setText(mydatabase.getStationName(expiredTicket.getFrom_station()));
//        icon_destination.setText(expiredTicket.getTo_station());
        return view;
    }
    ...
    public void dataSetChanges(ArrayList<ExpiredTicket> expiredTickets){
        this.expiredTickets = expiredTickets;
